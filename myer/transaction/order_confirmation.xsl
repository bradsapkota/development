    ...
    <td align="center" valign="top">
        <table align="center" class="em_main_table" bgcolor="#faf8f9" width="640" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed; width: 640px;">
            <tbody>
                ...
                <tr>
                    <td class="em_black em_aside" valign="top" align="left" style="font-family: Arial, sans-serif; font-size: 14px; color: #000000; padding-left: 63px; padding-right: 63px; line-height: 18px;">Your order is currently being processed. We’ll send you an email when your order is ready.<br/><br/><strong>Click &#38; Collect orders:</strong><br/>If you selected Click &#38; Collect, we’ll send you an email when your order is ready to be picked up from your preferred store.</td>
                </tr>
                <tr>
                    <td height="40" class="em_height" style="line-height: 0px; font-size: 0px;"><img src="http://image.email.myerone.com.au/lib/fe9713737563057f71/m/1/1503390624690_spacer.gif" alt="space" width="1" height="1" border="0" style="display: block;"/></td>
                </tr>
